...
export const SponsoredProductsCampaignReportMetrics = t.union([
  /**
...
export type SponsoredProductsCampaignReportMetrics = t.TypeOf<
  typeof SponsoredProductsCampaignReportMetrics
>
