...
export const SponsoredProductsAdGroupReportMetrics = t.union([
  /**
...
export type SponsoredProductsAdGroupReportMetrics = t.TypeOf<
  typeof SponsoredProductsAdGroupReportMetrics
>
