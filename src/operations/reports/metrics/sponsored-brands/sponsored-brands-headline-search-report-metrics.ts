...
export const SponsoredBrandsHeadlineSearchReportMetrics = t.union([
  /**
...
export type SponsoredBrandsHeadlineSearchReportMetrics = t.TypeOf<
  typeof SponsoredBrandsHeadlineSearchReportMetrics
>
